...
class AcaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create acao" do
    assert_difference("Acao.count") do
      post acaos_url, params: { acao: { data_busca: @acao.data_busca, preco: @acao.preco, sigla: @acao.sigla } }
    end
  ...
  test "should update acao" do
    patch acao_url(@acao), params: { acao: { data_busca: @acao.data_busca, preco: @acao.preco, sigla: @acao.sigla } }
